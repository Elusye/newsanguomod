...
public class Entry
{
    ...
    public static void Init()
    {
        ...
        FmodStudioDeferredBankRegistration.RegisterBank("res://newsanguo/audios/newsanguo.bank");
        FmodStudioDeferredBankRegistration.RegisterStudioGuidMappings("res://newsanguo/audios/GUIDs.txt");
