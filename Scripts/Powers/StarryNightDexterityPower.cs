...
public class StarryNightDexterityPower : TemporaryDexterityPower, IModPowerAssetOverrides
{
    public override AbstractModel OriginModel => ModelDb.Card<StarryNight>();
