...
public class starry_night_dexterity_power : TemporaryDexterityPower, IModPowerAssetOverrides
{
    public override AbstractModel OriginModel => ModelDb.Card<starry_night>();
