...
// 注册能力到游戏
[RegisterPower]
public class TriumphBrewPower : ModPowerTemplate
{
    // 能力类型：正面 Buff
    ...
    public override PowerAssetProfile AssetProfile => new(
        IconPath: "res://newsanguo/images/powers/ToABiggerGoblet.png",
        BigIconPath: "res://newsanguo/images/powers/ToABiggerGoblet_big.png"
    );
