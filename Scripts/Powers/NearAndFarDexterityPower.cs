...
/// <summary>
/// “忽近忽远”赋予的临时敏捷。回合结束时失去。
/// </summary>
[RegisterPower]
public class NearAndFarDexterityPower : TemporaryDexterityPower, IModPowerAssetOverrides
{
    public override AbstractModel OriginModel => ModelDb.Card<NearAndFar>();
