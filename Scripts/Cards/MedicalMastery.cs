...
public class MedicalMastery : NewsanguoCardTemplate
{
    ...
    public MedicalMastery() : base(2, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
            ...
            attackCommand.Results.SelectMany(results => results).Any(result => result.WasTargetKilled))
        {
            ...
            MedicalMastery? deckCopy = base.DeckVersion as MedicalMastery;
    ...
    private static void UpgradeDeckVersion(MedicalMastery deckCopy, int upgradeCount)
    {
