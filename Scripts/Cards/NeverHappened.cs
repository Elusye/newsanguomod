...
public class NeverHappened : NewsanguoCardTemplate
{
    ...
    public NeverHappened() : base(1, CardType.Skill, CardRarity.Common, TargetType.Self)
    {
    }
    ...
    {
        NewsanguoSfx.Play("event:/newsanguo/sfx/never_happened");
